...
public class Robot extends Actor{
    ...
    private void showId(boolean showIndex) {
        ...
        for (int i = 0; i < gameGrid.getActors(Robot.class).size(); i++) {
            Robot robot = (Robot) gameGrid.getActors(Robot.class).get(i);
            Point pt = gameGrid.toPoint(robot.getLocation());pt.x -=5;pt.y -=11;
